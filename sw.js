const CACHE = 'orbita-v3.1.0';
const ASSETS = [
  './','./index.html','./styles.css','./chat.css','./app.js','./engine.js','./config.js','./advisors.js','./booking-core.js','./booking-service.js','./manifest.webmanifest',
